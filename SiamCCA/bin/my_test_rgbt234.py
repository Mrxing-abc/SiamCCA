...
from SiamCCA.SiamCCATracker import SiamCCATracker
...
if __name__=='__main__':
    ...
    parser.add_argument('--model_path', default='../models/SimAm/SiamCCA_234_dualsp_45.pth', type=str, help='eval one special video')
    parser.add_argument('--result_dir', default='../result/RGB_T234_SimAm', type=str)
    parser.add_argument('--testing_dataset', default='RGB_T234', type=str)
    args = parser.parse_args()

    tracker = SiamCCATracker(args.model_path)

    root_dir = '../dataset/RGB_T234'
    rgbt_sequence = RGBT234(root_dir)
