...
if __name__=='__main__':
    ...
    parser.add_argument('--model_path', default='../models/SimAm/SiamCCA_234_dualsp_50.pth', type=str, help='eval one special video')
    parser.add_argument('--result_dir', default='../result/12_25', type=str)
