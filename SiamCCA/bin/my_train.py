...
from SiamCCA.loss import rpn_smoothL1, rpn_cross_entropy_balance
from SiamCCA.utils import adjust_learning_rate, freeze_former_3_layers, freeze_rgbt_layers, unfreeze_rgbt_layers
...
def train(data_dir, resume_path=None, vis_port=None, init=None):
    ...
    #-----------------------
    rgbt_sequence = RGBT234_Lasher('D:/BaiduNetdiskDownload/DataSets/LasHeR3/LasHeR3', list='trainingsetList.txt')
    ...
    for epoch in range(start_epoch, config.epoch + 1):
        ...
        if epoch % config.save_interval == 0:
            if not os.path.exists('../models/'):
                os.makedirs("../models/")
            save_name = "../models/6_9/SiamCCA_234_dualsp_{}.pth".format(epoch)
...
if __name__ == '__main__':
    ...
    # parameters
    parser=argparse.ArgumentParser(description="SiamCCA Train")

    parser.add_argument('--resume_path',default='../models/6_9/SiamCCA_234_dualsp_23.pth', type=str, help="")

    parser.add_argument('--data',default='D:/BaiduNetdiskDownload/DataSets/LasHeR3/LasHeR3',type=str,help=" the path of data")
