...
# 替换原有的变换函数
z_r_transforms = custom_transforms
z_t_transforms = custom_transforms
x_r_transforms = custom_transforms
x_t_transforms = custom_transforms
