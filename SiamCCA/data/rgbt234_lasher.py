...
class RGBT234_Lasher(object):
    ...
    def __init__(self, root_dir, list = 'trainingsetList.txt'):
    ...
    def _check_integrity(self, root_dir, list = 'trainingsetList.txt'):
        list_file = os.path.join(root_dir, list)
...
if __name__ == "__main__":
    root_dir = 'D:/BaiduNetdiskDownload/DataSets/LasHeR3/LasHeR3'
