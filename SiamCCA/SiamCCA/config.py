...
class Config:
    ...
    #--------
    pairs_num_per_epoch = 64000 #6400 800
    eps = 0.01    #
    #--------
    ...
    train_batch_size = 4 #28 4              # training batch size
    valid_batch_size = 8             # validation batch size
    train_num_workers = 0 #16 0                # number of workers of train dataloader
